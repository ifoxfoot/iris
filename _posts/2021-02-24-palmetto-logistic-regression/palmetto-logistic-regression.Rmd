...
ggplot(data = palmetto, aes(x = species, y = length, fill = species)) + 
  geom_violin() + 
  #facet_wrap(~species) + 
  ...
  labs(x = "Species", y = "length (cm)",
       caption = 
      "Figure 1: Length of Sabal etonia vs Serenoa repens palmettos in South Central Florida
(Data: Abrahamson) Length is defined as the widest area of the canopy. From this graph you can see that
Sabal etonia has a slightly larger mean length.")
